...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert data into t_responden_dosen table
    $query = $db->prepare("INSERT INTO t_responden_dosen (responden_dosen_id, Survey_id, responden_tanggal, responden_nama, responden_nip, responden_unit) VALUES (NULL, 14, ?, ?, ?, ?)");
    ...
    // Insert data into t_jawaban_dosen table
    if (isset($_POST['jawaban']) && is_array($_POST['jawaban'])) {
        foreach ($_POST['jawaban'] as $soal_id => $jawaban) {
            $query = $db->prepare('INSERT INTO t_jawaban_dosen (jawaban_dosen_id, responden_dosen_id, soal_id, jawaban) VALUES (NULL, ?, ?, ?)');
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Kuesioner Dosen</h2>
              <h2 style="text-align: center;">Sistem Pengelolaan Sarana dan Prasarana Politeknik Negeri Malang</h2>
              <br>
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 14;
