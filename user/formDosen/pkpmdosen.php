...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("INSERT INTO t_responden_dosen (responden_dosen_id, Survey_id, responden_tanggal, responden_nama, responden_nip, responden_unit) VALUES (NULL, 16, ?, ?, ?, ?)");
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Sistem Pengelolaan Kegiatan Pengabdian kepada Masyarakat Politeknik Negeri Malang</h2>
              <br>
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 16;
