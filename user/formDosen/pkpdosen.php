...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("INSERT INTO t_responden_dosen (responden_dosen_id, Survey_id, responden_tanggal, responden_nama, responden_nip, responden_unit) VALUES (NULL, 15, ?, ?, ?, ?)");
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 15;
