...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("INSERT INTO t_responden_mahasiswa (responden_mahasiswa_id, Survey_id, responden_tanggal, responden_nama, responden_prodi, responden_nim, responden_email, responden_hp, tahun_masuk) VALUES (NULL, 4, ?, ?, ?, ?, ?, ?, ?)");
    ...
    header('Location: lkpmmahasiswa.php');
    exit();
}
?>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Keadilan Perlakuan Akademik Politeknik Negeri Malang</h2>
              <br>
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 4;
