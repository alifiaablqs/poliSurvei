...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $Prodi = $_POST['Prodi'];
    $Email = $_POST['Email'];
    $HP = $_POST['HP']; // Make sure this matches the form field name
    ...
    $_SESSION["HP"] = $HP; // Make sure this matches the form field name
    $_SESSION["Tahun_Masuk"] = $Tahun;
    header('Location: kspmahasiswa.php');
    exit();
}
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="text" name="NIM" class="form-control rounded-0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>Nama</h4>
                <div class="form-group">
                    <input type="text" name="Nama" class="form-control rounded-0" id="exampleInputRounded0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>Prodi</h4>
                <div class="form-group">
                    <input type="text" name="Prodi" class="form-control rounded-0" id="exampleInputRounded0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>Email</h4>
                <div class="form-group">
                    <input type="email" name="Email" class="form-control rounded-0" id="exampleInputRounded0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>No HP</h4>
            ...
            <div class="col-md-6">
                <h4>Tahun Masuk</h4>
                <div class="form-group">
                    <input type="text" name="Tahun_Masuk" class="form-control rounded-0" id="exampleInputRounded0" required>
                </div>
            </div>
        </div>
    </div>
