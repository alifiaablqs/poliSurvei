...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Insert data into t_responden_alumni table
    $query = $db->prepare("INSERT INTO t_responden_alumni (responden_alumni_id, survey_id, responden_tanggal, responden_nim, responden_nama, responden_prodi, responden_hp, responden_email, tahun_lulus) VALUES (NULL, 22, ?, ?, ?, ?, ?, ?, ?)");
    $query->bind_param(
      'sssssss',
      $_SESSION["Tanggal"],
      $_SESSION["NIM"],
    ...
    // Insert data into t_jawaban_alumni table
    if (isset($_POST['jawaban']) && is_array($_POST['jawaban'])) {
        foreach ($_POST['jawaban'] as $soal_id => $jawaban) {
            $query = $db->prepare('INSERT INTO t_jawaban_alumni (jawaban_alumni_id, responden_alumni_id, soal_id, jawaban) VALUES (NULL, ?, ?, ?)');
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Kuesioner Alumni</h2>
              <h2 style="text-align: center;">Fasilitas dan Pelayanan Alumni Politeknik Negeri Malang</h2>
              <br>
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $survey_id = isset($_GET['survey_id']) ? $_GET['survey_id'] : 22;
