<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: pplpindustri.php');  
    exit();
  }
      ...
      ?>
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                <h4>Jabatan</h4>
                <div class="form-group">
                <input type="text" name="Jabatan" class="form-control rounded-0" >
                </div>
            </div>
            <div class="col-md-6">
                <h4>Perusahaan</h4>
                <div class="form-group">
                <input type="text" name="Perusahaan" class="form-control rounded-0" >
                </div>
            </div>
            <div class="col-md-6">
                <h4>Email</h4>
            ...
            <div class="col-md-6">
                <h4>Kota</h4>
                <div class="form-group">
                <input type="text" name="Kota" class="form-control rounded-0" >
                </div>
            </div>
            <div class="col-md-6">
                <h4>Tanggal</h4>
                <div class="form-group">
                <input type="datetime-local" value="<?php  echo date('Y-m-d\TH:i:s')?>" name="Tanggal" class="form-control rounded-0" >
                </div>
            </div>
        </div>
        <!-- /.card-body -->
        <div class="card-footer">
          <div class="btn-group">
            ...
            <button type="button" class="btn-common btn-kembali" onclick="window.location.href='Profil.php'">Kembali</button>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            <form action="user_action.php?act=edit&id=<?php echo $id?>" method="post">
              ...
              <div class="form-group">
                ...
                <button type="button" class="btn btn-warning" onclick="window.location.href='Profil.php'">Kembali</button>
              </div>
            </form>
        </div>
