...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $query = $db->prepare("INSERT INTO t_responden_industri (responden_industri_id, survey_id, responden_tanggal, responden_nama, responden_jabatan, responden_perusahaan, responden_email, responden_hp, responden_kota) VALUES (NULL, 11, ?, ?, ?, ?, ?, ?, ?)");
    $query->bind_param('sssssss', $_SESSION["Tanggal"], $_SESSION["Nama"], $_SESSION["Jabatan"], $_SESSION["Perusahaan"], $_SESSION["Email"],$_SESSION["HP"], $_SESSION["Kota"]);
    ...
    // Insert data into t_jawaban_industri table
    if (isset($_POST['jawaban']) && is_array($_POST['jawaban'])) {
        foreach ($_POST['jawaban'] as $soal_id => $jawaban) {
            $query = $db->prepare('INSERT INTO t_jawaban_industri (jawaban_industri_id, responden_industri_id, soal_id, jawaban) VALUES (NULL, ?, ?, ?)');
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <h2 style="text-align: center;">Kuesioner Industri</h2>
              <h2 style="text-align: center;">Pelacakan Pengguna Lulusan Politeknik Negeri Malang</h2>
              <br>
                        ...
                        <form action="" method="post">
                          <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                              ...
                              $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 11;
