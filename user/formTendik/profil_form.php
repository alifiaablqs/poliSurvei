<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: psdmtendik.php');
    exit();
}
      ...
      ?>
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="NIP" class="form-control rounded-0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>Nama</h4>
            ...
            <div class="col-md-6">
                <h4>Unit</h4>
                <div class="form-group">
                <input type="text" name="Unit" class="form-control rounded-0" id="exampleInputRounded0" required>
                </div>
            </div>
            <div class="col-md-6">
                <h4>Tanggal</h4>
