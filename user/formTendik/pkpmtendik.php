...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("INSERT INTO t_responden_tendik (responden_tendik_id, Survey_id, responden_tanggal, responden_nama, responden_nopeg, responden_unit) VALUES (NULL, 21, ?, ?, ?, ?)");
...
<div class="row">
  ...
  <table class="table table-sm table-bordered">
    ...
    $Survey_id = isset($_GET['Survey_id']) ? $_GET['Survey_id'] : 21;
